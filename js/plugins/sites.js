...
$(function () {
  ...
  for (var i = 0; i < els.length; i++) {
    ...
    cfg.el = el;
    cfg.api = api;
    cfg.avatar = 'https://cdn1.tianli0.top/gh/cdn-x/placeholder@1.0.1/link/8f277b4ee0ecd.svg';
    cfg.screenshot = 'https://cdn1.tianli0.top/gh/cdn-x/placeholder@1.0.1/cover/76b86c0226ffd.svg';
    sitesjs.layout(cfg);
  }
});
