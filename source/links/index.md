...
<script>loadQexoFriends("qexo-friends", "https://admin.redish101.tk")</script>
  

<center><h2>友链申请</h2></center>
<div id="friends-api"></div>
<script src="https://cdn.jsdelivr.net/gh/Fgaoxing/blog-cdn@main/source/js/friends-api.js"></script>
<script>qexo_friend_api("friends-api","https://admin.redish101.tk");</script>